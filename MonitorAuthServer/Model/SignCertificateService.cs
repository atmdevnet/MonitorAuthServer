...
{
    public class SignCertificateService : IDisposable
    {
        private SignCertificateConfig _config = null;
        ...
        public SignCertificateService(IOptions<SignCertificateConfig> config, IHostingEnvironment env)
        {
        ...
        public void EnsureCertificateAvailable()
        {
            if (!IsAvailable)
            {
                throw (LastError ?? new CryptographicException("Brak certyfikatu podpisu."));
            }
        }
